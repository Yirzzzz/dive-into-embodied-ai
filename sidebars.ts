  ...
  foundationsOverviewSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'link', label: '世界模型(World Model)', href: '/docs/foundations/world-model/intro' },
      ],
    },
    {
      type: 'category',
  ...
  foundationsWorldModelSidebar: [
    {
      ...
      link: { type: 'doc', id: 'foundations/world-model/intro' },
      collapsible: false,
  ...
  practicesOverviewSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'link', label: 'π₀.₅ + RECAP：LIBERO 复现', href: '/docs/practices/vla/recap-libero' },
